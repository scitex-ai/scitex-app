...
# (project=scitex-app, owner=ywatanabe1989, repo=scitex-app,
...
TMPDIR="/tmp/publish-scitex_app-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-app dist/* uploaded to PyPI via manual OIDC trusted publishing"
